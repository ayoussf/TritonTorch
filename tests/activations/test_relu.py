...
class ReLUTest(TritonKernelTest):
    """
    Test class for ReLU activation.
    """
...
class TestReLU:
    """
    Pytest test class for ReLU activation.
    """
    @pytest.fixture
    ...
    def test_relu(self,
                  ...
                  seed: int,):
        """
        Test ReLU forward and backward.
        """
        B, M, N = base_shape
        ...
        test = ReLUTest(config, B, M, N, dim)
        test.run()